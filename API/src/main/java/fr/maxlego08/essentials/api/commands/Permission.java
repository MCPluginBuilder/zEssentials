...
public enum Permission {
    ...
    ESSENTIALS_DEL_HOME_OTHER("Allows to delete another player's home"),
    ESSENTIALS_HOME_PUBLIC("Allows to make one of your homes public"),
    ESSENTIALS_HOME_VISIT("Allows to visit public and shared homes"),
    ESSENTIALS_HOME_SHARE("Allows to share a home with other players"),
    ESSENTIALS_HOME_CATEGORY("Allows to set a category on a home"),
    ESSENTIALS_HOME_FAVORITE("Allows to mark a home as favorite"),
    ESSENTIALS_HOME_IMPORT("Allows to import homes from other plugins"),
    ESSENTIALS_FREEZE,
    ESSENTIALS_KICK,
    ...
    ESSENTIALS_IGNORE("Allows to ignore a player, blocking their private messages and teleport requests"),
    ESSENTIALS_IGNORE_LIST("Allows to list the players you are ignoring"),
    ESSENTIALS_PING_SOUND("Allows to toggle the chat ping sound"),
    ESSENTIALS_GIVE,
    ESSENTIALS_GIVE_ALL,
    ...
    ESSENTIALS_MAIL_SEND("Allows to send a mail to a player, online or not"),
    ESSENTIALS_MAIL_READ("Allows to read the mails you received"),
    ESSENTIALS_MAIL_SEND_ALL("Allows to send a mail to every online player"),
    ESSENTIALS_MAIL_CLEAR_MESSAGES("Allows to delete the mails of a player"),

...
public enum Message {
    ...
    COMMAND_VANISH_ENABLE("&7Vanish <success>enable &7for &f%player%<success>."),
    COMMAND_VANISH_DISABLE("&7Vanish <error>disable &7for &f%player%<success>."),
    ...
    COMMAND_TP_OTHER("&7You just teleported #34cfe0%player% &7to #34cfe0%target%&7."),
    ...
    DESCRIPTION_VANISH("Toggle vanish mode"),
    ...
    DESCRIPTION_COMPACT("Compact a material into blocks, aliases: /blocks, /condense"),
    ...
    DESCRIPTION_IGNORE("Ignore a player, blocking their private messages and teleport requests"),
    DESCRIPTION_UNIGNORE("Stop ignoring a player"),
    DESCRIPTION_IGNORE_LIST("List the players you are ignoring"),
    DESCRIPTION_PING_SOUND("Toggle the chat ping sound"),
    DESCRIPTION_DEL_HOME_OTHER("Delete a home of another player"),
    DESCRIPTION_HOME_PUBLIC("Make one of your homes public"),
    DESCRIPTION_PUBLIC_HOMES("List the public homes"),
    DESCRIPTION_HOME_SHARE("Share a home with a player"),
    DESCRIPTION_HOME_UNSHARE("Stop sharing a home with a player"),
    DESCRIPTION_HOME_SHARES("List the players a home is shared with"),
    DESCRIPTION_HOME_CATEGORY("Set the category of a home"),
    DESCRIPTION_HOME_FAVORITE("Toggle a home as favorite"),
    DESCRIPTION_HOME_IMPORT("Import homes from another plugin"),
    DESCRIPTION_POWER_TOOLS_TOGGLE("Toggle power tools"),
    DESCRIPTION_SOCIALSPY("Display private messages of players"),
    DESCRIPTION_COMPACT_ALL("Compact every item in your inventory, aliases: /blocksall, /condenseall"),
    ...
    DESCRIPTION_MAIL_SEND("Send a mail to a player, online or not"),
    DESCRIPTION_MAIL_READ("Read the mails you received"),
    DESCRIPTION_MAIL_SEND_ALL("Send a mail to every online player"),
    DESCRIPTION_MAIL_CLEAR_MESSAGES("Delete the mails of a player"),
    ...
    COMMAND_HOME_FEATURE_DISABLED("<error>This home feature is disabled on this server."),
    COMMAND_HOME_PUBLIC_ENABLE("<success>Your home &f%name%<success> is now public."),
    COMMAND_HOME_PUBLIC_DISABLE("<success>Your home &f%name%<success> is no longer public."),
    COMMAND_HOME_PUBLIC_LIMIT("<error>You have reached the maximum number of public homes (&f%max%<error>)."),
    COMMAND_HOME_NOT_ACCESSIBLE("<error>The home &f%name%<error> of &f%player%<error> is not accessible to you."),
    COMMAND_PUBLIC_HOMES_HEADER("<success>Public homes (&f%count%<success>):"),
    COMMAND_PUBLIC_HOMES_LINE("&7- &f%player%&7:&f%name% <click:run_command:'/home %player%:%name%'><hover:show_text:'&7Teleport to this home'><#34cfe0>[Teleport]</click></hover>"),
    COMMAND_PUBLIC_HOMES_EMPTY("<error>There is no public home."),
    COMMAND_HOME_SHARE_ADD("<success>You shared your home &f%name%<success> with &f%player%<success>."),
    COMMAND_HOME_SHARE_REMOVE("<success>You stopped sharing your home &f%name%<success> with &f%player%<success>."),
    COMMAND_HOME_SHARE_ALREADY("<error>Your home &f%name%<error> is already shared with &f%player%<error>."),
    COMMAND_HOME_SHARE_NOT("<error>Your home &f%name%<error> is not shared with &f%player%<error>."),
    COMMAND_HOME_SHARE_SELF("<error>You cannot share a home with yourself."),
    COMMAND_HOME_SHARE_LIMIT("<error>You have reached the maximum number of shares for this home (&f%max%<error>)."),
    COMMAND_HOME_SHARE_LIST_HEADER("<success>Home &f%name%<success> is shared with &f%count% <success>player(s):"),
    COMMAND_HOME_SHARE_LIST_LINE("&7- &f%player%"),
    COMMAND_HOME_SHARE_LIST_EMPTY("<error>Home &f%name%<error> is not shared with anyone."),
    COMMAND_HOME_CATEGORY_SET("<success>The category of your home &f%name%<success> is now &f%category%<success>."),
    COMMAND_HOME_CATEGORY_RESET("<success>The category of your home &f%name%<success> has been removed."),
    COMMAND_HOME_CATEGORY_INVALID("<error>Invalid category name."),
    COMMAND_HOME_FAVORITE_ADD("<success>Your home &f%name%<success> is now a favorite."),
    COMMAND_HOME_FAVORITE_REMOVE("<success>Your home &f%name%<success> is no longer a favorite."),
    COMMAND_HOME_PREVIEW("&7Home &f%name% &8- &7%world% &8(&7%x%&8, &7%y%&8, &7%z%&8) <click:run_command:'/home %name% confirm'><#34cfe0>[Teleport]</click>"),
    COMMAND_HOME_IMPORT_START("<success>Importing homes from &f%source%<success>..."),
    COMMAND_HOME_IMPORT_DONE("<success>Import finished: &f%imported% <success>imported, &f%skipped% <success>skipped, &f%errors% <success>errors."),
    COMMAND_HOME_IMPORT_UNKNOWN("<error>Unknown import source &f%source%<error>. Available: essentialsx."),
    COMMAND_HOME_IMPORT_ERROR("<error>An error occurred during the import, check the console."),
    ...
    COMMAND_PING_SOUND_ENABLE("&7Chat ping sound <success>enabled &7for &f%player%<success>."),
    COMMAND_PING_SOUND_DISABLE("&7Chat ping sound <error>disabled &7for &f%player%<error>."),
    COMMAND_IGNORE_ADD("<success>You are now ignoring &f%player%<success>. You will no longer receive their private messages or teleport requests."),
    COMMAND_IGNORE_REMOVE("<success>You are no longer ignoring &f%player%<success>."),
    COMMAND_IGNORE_ALREADY("<error>You are already ignoring &f%player%<error>."),
    COMMAND_IGNORE_NOT("<error>You are not ignoring &f%player%<error>."),
    COMMAND_IGNORE_SELF("<error>You cannot ignore yourself."),
    COMMAND_IGNORE_LIST_EMPTY("<error>You are not ignoring anyone."),
    COMMAND_IGNORE_LIST_HEADER("<success>You are ignoring &f%count% <success>player(s):"),
    COMMAND_IGNORE_LIST_LINE("&7- &f%player%"),
    COMMAND_MESSAGE_IGNORE_PLAYER("<error>You cannot send a message to #34cfe0%player%<error> they are ignoring you."),
    ...
    MAILBOX_MESSAGE_SEND("<success>Your mail was sent to &f%player%<success>."),
    MAILBOX_MESSAGE_RECEIVE("<primary>&f%player% <primary>sent you a mail &8(&f/mail read&8)"),
    MAILBOX_MESSAGE_SEND_ALL("<success>Your mail was sent to &f%amount% <success>player(s)."),
    MAILBOX_MESSAGE_NOTIFY("<primary>You have &f%amount% <primary>unread mail(s), use <click:run_command:'/mail read'><hover:show_text:'&fClick to read your mails'>&f/mail read</hover></click><primary>."),
    MAILBOX_MESSAGE_EMPTY("<error>You don't have any mail."),
    MAILBOX_MESSAGE_HEADER(MessageType.WITHOUT_PREFIX, "", "<primary>Your mails <secondary>(&f%amount%<secondary>)", ""),
    MAILBOX_MESSAGE_LINE(MessageType.WITHOUT_PREFIX, "<secondary>&8[&f%date%&8] <primary>%player%<secondary>: &f%message%"),
    MAILBOX_MESSAGE_FOOTER(MessageType.WITHOUT_PREFIX, "", "<secondary>Use <click:run_command:'/mail clearmessages'><hover:show_text:'&fClick to delete your mails'>&f/mail clearmessages</hover></click><secondary> to delete them.", ""),
    MAILBOX_MESSAGE_CLEAR("<success>You have just deleted the mails of &f%player%<success>."),
    MAILBOX_MESSAGE_SELF("<error>You cannot send a mail to yourself."),
    MAILBOX_MESSAGE_MUTE("<error>You cannot send a mail while you are muted."),
    MAILBOX_MESSAGE_IGNORE("<error>&f%player% <error>does not want to receive your mails."),
    MAILBOX_MESSAGE_FULL("<error>The mailbox of &f%player% <error>is full."),
    MAILBOX_MESSAGE_TOO_LONG("<error>Your mail cannot be longer than &f%max% <error>characters."),
